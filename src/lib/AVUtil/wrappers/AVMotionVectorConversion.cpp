...
using internal::avutil::AVMotionVector_55_56_57_58_59_60_61;
...
parseMotionData(const LibraryVersions &libraryVersions, const uint8_t *data, const size_t dataSize)
{
  ...
  if (libraryVersions.avutil.major == 54)
  {
    ...
    return motionVectors;
           ...
           libraryVersions.avutil.major == 60 || //
           libraryVersions.avutil.major == 61)
  {
    const auto nrMotionVectors = dataSize / sizeof(AVMotionVector_55_56_57_58_59_60_61);
    for (size_t index = 0; index < nrMotionVectors; ++index)
    {
      const auto byteOffset = sizeof(AVMotionVector_55_56_57_58_59_60_61) * index;
      const auto p =
          reinterpret_cast<const AVMotionVector_55_56_57_58_59_60_61 *>(data + byteOffset);
